...
public class MainPane extends BorderPane {
	...
	public MainPane(Controller controller) {
		...
		leftBox.setPrefWidth(500);
			...
			//FACCIO QUI SOTTO
			Set<Pacco> pacchiDaAprire = controller.getPacchiDaAprire();
			for(Pacco p : pacchiDaAprire) {
				this.creaPaccoButton(buttonPane, p, "default");
			}
	...
	private void interpellaDottore() {
		if(controller.getFase()!=Fase.INTERPELLA_DOTTORE) {
			Controller.alert("ERRORE", "ERROREE", "ERRORORORIR");
			return;
		}
		Risposta risposta = controller.interpellaDottore();
		txtRispostaDottore.setText(risposta.toString());
	...
	private String sintetizzaOutput() {
		...
		String result="CONCORRENTE: \n"+controller.getPaccoConcorrente().toString()+"\n\n TABELLONE PREMI\n";
		for(Valore e : controller.getPremi()) {
